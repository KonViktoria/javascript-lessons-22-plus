...
async function addNumbers(a, b) {
    const num1 = await input({ message: `Введите первое число (по умолчанию ${a}):`, default: a });
    const num2 = await input({ message: `Введите второе число (по умолчанию ${b}):`, default: b });
